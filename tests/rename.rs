...
fn dry_run_rename_to_plans_symlink_with_new_name() {
    ...
    fs::write(root.join("orig.txt.lua"), b"return { rename_to = 'renamed.txt' }").unwrap();
    ...
    cmd.assert()
        ...
        .stdout(predicate::str::contains("Would symlink")
            .and(predicate::str::contains("/home/renamed.txt").or(predicate::str::contains("renamed.txt"))));
}
